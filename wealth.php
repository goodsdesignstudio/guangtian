...
<body>
	...
	<div id="wealth-wrap" class="programOutWrap">
		...
		<section class="wealthWrap">
			...
			<div class="wealth-area-1">
				...
				<div class="sun" data-r='{"opacity": 0, "y": 30}'><img src="./images/wealth-sun.svg"></div>
				<div class="cloud-container">
					<div class="bg-area" data-r='{"opacity": 0, "y": 30, "stagger":0.1}'>
						<div class="one"><img src="images/w-cloud-3.png"></div>
						<div class="two"><img src="images/w-cloud-2.png"></div>
						<div class="red-envelope">
							<div class="close"><img src="./images/red-envelope-close.svg"></div>
							<div class="opened">
								<img src="./images/red-envelope-open.svg" class="rea-pack-2026">
								<div class="money money-1"><img src="./images/w-money-1.png"></div>
								<div class="money money-2"><img src="./images/w-money-2.png"></div>
								<div class="money money-3"><img src="./images/w-money-3.png"></div>
							</div>
						</div>
						<div class="three"><img src="images/w-cloud-1.png"></div>
					</div>
				</div>
			...
			<div class="c-yt-area is-white">
				<div class="article-area mx-2026">
					<div class="title">
						<b class="track-2026">一年之計在於春</b>
					</div>
					<div class="content">
				...
				<!-- 裝飾-手機板 -->
				<div class="mobile-deco-bf-yt-container-2026 hide-for-large">
					<div class="red-envelope">
						<div class="re-1">
							<img src="images/wealth-bf-yt-ctn-re-deco-1.svg" alt="">
						</div>
						<div class="re-2">
							<img src="images/wealth-bf-yt-ctn-re-deco-2.svg" alt="">
						</div>
						<div class="re-3">
							<img src="images/wealth-bf-yt-ctn-re-deco-3.svg" alt="">
						</div>
					</div>
					<div class="lion">
						<img src="images/wealth-bf-yt-ctn-lion-deco-1.svg" alt="">
					</div>
					<div class="bg">
						<img src="images/w-cloud-2.png" alt="">
					</div>
				</div>
...
<script>
	...
	if (winWidth <= 1024) {
		...
		(function mbBfYTCtn() {
			const container = document.querySelector('.mobile-deco-bf-yt-container-2026');
			if (!container) return;
