...
<body id="poem" class="poem-bg">
	<?php include 'topmenu.php'; ?>

	<section class="poemWrap">
		<div class="poem-aniWrap">
			<div class="bigpoem"><img src="images/bigpoem.png"></div>
			<div class="poem-bottle"><img src="images/poem-pic-1.png"></div>
		</div>
		...
		<div class="poem-container" data-img="images/poem-repeat.svg">
			<div class="item">
				<div class="bg"><img src="images/poem-1.svg"></div>
	...
	<section class="poem-detailWrap">
		<div class="back show-for-large">
			<img src="images/pd-poem-back.png">
		</div>
		...
		<div class="poem-detail-innerWrap">
			...
			<ul class="explainList">
				<li>
					<div class="title">典故
						<img src="./images/poem-title-deco.png" alt="">
					</div>
