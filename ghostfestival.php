	...
	<div class="programOutWrap">
		...
		<div class="bannerWrap bannerWrap-2026">
				...
				<div class="repeat-area" data-img="images/cd-repeat.svg">
					...
					<div class="item">
						...
						<div class="title-area">
							...
							<div class="day">農曆 七月十三至<br class="hide-for-large">十七日</div>
			...
			<div class="article-area grid-x" data-r='{"opacity": 0, "y": 40, "delay": 1.2}'>
				...
				<div class="title cell shrink">地官赦罪</div>
		...
		<section class="puduWrap">
			...
			<div class="pudu-area-1">
				...
				<div class="ghost-container">
					...
					<div class="ghost-area grid-x align-center align-top">
						...
						<div class="ghost cell shrink"><img src="images/ghost-1.png"></div>

						<div class="ghost cell shrink"><img src="images/ghost-2.png"></div>
			...
			<div class="c-yt-area c-yt-area-2026">
				...
				<div class="mobile-pudu-deco-3 hide-for-large" data-r='{"opacity": 0, "xPercent": -100}'><img
						src="images/pudu-deco-3.png"></div>

				<div class="mobile-pudu-deco-4 hide-for-large" data-r='{"opacity": 0, "x": 60}'><img
						src="images/pudu-deco-4.png"></div>
			...
			<div class="c-feature-area">
				...
				<div class="mobile-head hide-for-large"><img src="images/c-feature-mobile.svg"></div>



				<div class="cd-slide-wrap">

					<div class="cd-slide-container is-ghost">
						...
						<ul class="featureList">
							...
							<li>
								...
								<div class="content">
									根據道教正統古禮科儀，中元普度法會從開壇請神、召請亡魂、赦罪超拔、普度施食、度化升天，都必須經過一定的程序，最少應做滿五天才能完整，否則不但對亡魂毫無幫助，陽世報恩人的心意也會打折扣。因此，本宮懷抱著陽世報恩人及功德主的託付，遵循道教正統科儀，以最嚴謹的態度和方式，傾盡全力讓中元超拔法會完整、圓滿。
								</div>
							...
							<li>
								...
								<div class="content">
									陽世報恩人及功德主參加中元超拔法會，都是發自對於亡魂的慈悲心與孝心，台中廣天宮財神爺感受到眾人的祈求，在法會蘭場的佈置上，無不悉心考究，不僅把多數人印象中陰森的法會現場，營造出莊嚴肅穆的氛圍，還為所有受拔薦亡魂設置安奉牌位，以表對亡魂的謹慎與尊敬。
								</div>
							...
							<li>
								...
								<div class="content">
									一般普度法會，只透過招魂幡招引亡魂，但是地府冥王、城隍和酆都，都不會讓受罰的亡魂隨意出入陰間，以至於拔度的亡魂未能到場。因此，台中廣天宮所舉辦的超拔法會，根據《道藏》古禮，恭請地官大帝、太乙救苦天尊調派神虎何喬二元帥（陽神大聖何昌、陰神大聖喬荀），前往陰陽兩界找尋指定亡魂，並手持如通行令的「攝召關文」，通知陰陽兩界各路關兵將放行，讓亡魂能確實到達蘭場安奉。
								</div>
					...
					<div class="mobile-open-btn hide-for-large">
						...
						<img src="images/cd-mobile-openbtn.svg">

						<img src="images/cd-mobile-openbtn-arrow.svg" class="mob-arrow">
			...
			<div class="c-god-area">
				...
				<div class="mobile-head hide-for-large"><img src="images/c-god-mobile.svg"></div>



				<div class="cd-slide-wrap mb-2026">
			...
			<div class="c-area-2">
				...
				<div class="head show-for-large">普度「無主孤魂」</div>

				<div class="mobile-head hide-for-large"><img src="images/c-area2-head-mobile.svg"></div>
				...
				<div class="cd-slide-wrap">
					...
					<div class="cd-slide-container is-ghost">
						...
						<div class="ghost-custom-area-1">

							<div class="content">

								幫助無主孤魂早日脫離苦海，無主孤魂也會幫助你度過難關

								除了有主亡魂之外，陰陽二界之中仍有許多無人供奉、超拔的無主孤魂，我們懷抱著慈悲心，廣開中元普桌，請這些孤魂享用一頓山珍海味，就
								像是認領孤兒一樣，安慰孤魂無人供奉的遺憾，同時恭請地官大帝赦免其罪，並由太乙救苦天尊度化拔薦，使其早日脫離苦海，得道昇天或投胎轉世。無主孤魂也可藉由法會沾領功德，陽世報恩人也能累積自身的功德福報。
							...
							<div class="pudu-trans-area"><img src="images/c-trans.jpg"></div>
			...
			<div class="flowWrap">
				...
				<div class="head show-for-large">中元節大法會流程介紹</div>

				<div class="mobile-head hide-for-large"><img src="images/c-process-head-mobile.svg"></div>
						...
						<div class="flow-sliderWrap">
							...
							<ul class="flow-sliderList" data-flickity='{
								...
								<li>
									...
									<img src="images/flow-1.png" class="show-for-large">

									<img src="images/flow-1-mobile.png" class="hide-for-large">
...
<script>
	...
	console.log(winWidth, 'AAAAAAAAAAAAAAAAAAAA');
	...
	gsap.timeline({
		paused: true,
		scrollTrigger: {
			trigger: ".pudu-area-1 .byebye-area",
			toggleActions: "play none play none", //重覆觸發
			start: "center 80%",
			end: "bottom 80%",
			// markers: true,
		},
	}).to(".pudu-area-1 .content-area", {

		duration: 1,
		opacity: 1,
		y: 0,
	}).to(".byebye-area .table", {
		duration: 1,
		opacity: 1,
		y: 0,

	}, "<.5").to(".byebye-area .byebye-item img", {
		duration: 0.6,
		opacity: 1,
		y: 0,
		stagger: {
	...
	$(".mobile-open-btn").on("click", function (e) {
		...
		const isClosing = $pa.hasClass("is-open");
		...
		if (isClosing) {
			...
			$("html, body").stop().animate({ scrollTop: targetTop }, 300, function () {
				...
				// 補充說明：如果你的箭頭圖示是綁定在 .is-open 上，而且你希望箭頭「提早」轉回去，
				// 可以將 $pa.removeClass("is-open") 移到 slideUp() 的上一行，
				// 但前提是 .is-open 沒有綁定任何會改變區塊高度的 CSS 屬性。
			});
